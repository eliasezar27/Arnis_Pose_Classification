...
def strike(part_line, bboxList):
	...
	if kp_shown:
		...
		# Left Leg Strike
		elif r_elbow > 160 and r_shoulder < 90 and l_elbow in range(35, 90) and l_shoulder in range(45, 135) and not r_wrist_up and not l_wrist_up and rw_near_rs and not lw_near_ls:
		...
		# Right Block
		elif r_elbow > 140 and r_shoulder in range(148,158) and l_elbow > 150 and l_shoulder in range(30, 50) and not r_wrist_up and l_wrist_up and rw_near_rs and not lw_near_ls:
		...
		elif r_elbow > 180 and r_shoulder in range(115, 135) and l_elbow > 140 and l_shoulder < 20 and not r_wrist_up and l_wrist_up and rw_near_rs and not lw_near_ls:
			label = "Right Shoulder Block"
			print(label)

		# Stomach Thrust Block
		elif r_elbow > 135 and r_shoulder < 20 and l_elbow > 160 and l_shoulder in range(125, 145) and not r_wrist_up and not l_wrist_up and not rw_near_rs and lw_near_ls:
		...
		# Right Chest Block
		elif r_elbow > 160 and r_shoulder in range(109, 129) and l_elbow > 160 and l_shoulder < 50 and r_wrist_up and l_wrist_up and rw_near_rs and not lw_near_ls:
			label = "Right Chest Block"
			print(label)

		# Right Leg Block
		elif r_elbow > 160 and r_shoulder > 120 and l_elbow in range(33, 43) and l_shoulder in range(92, 110) and not r_wrist_up and not l_wrist_up and rw_near_rs and lw_near_ls:
			label = "Right Leg Block"
			print(label)

		# Left Leg Block
		elif r_elbow > 160 and r_shoulder in range(45, 55) and l_elbow < 30 and l_shoulder in range(110, 120) and not r_wrist_up and not l_wrist_up and not rw_near_rs and not lw_near_ls:
